...
def test_retrieve_favorites_without_api_key(logger):    
    logger.info("test_retrieve_favorites_without_api_key favorites has started:")
    response = client.get_favorites("")
    assert response.status_code == 401

    
def test_retrieve_favorites_with_invalid_api_key(logger):    
    logger.info("test_retrieve_favorites_with_invalid_api_key favorites has started:")
